...
<html>
  ...
  <head>
    ...
    <title>Class ModuleDependencyAttribute
   | site </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class ModuleDependencyAttribute
   | site ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute">
  
  
  <h1 id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute" class="text-break">Class ModuleDependencyAttribute
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><a class="xref" href="../../api/ParmaGIS.Core.Modularity.ModuleAttribute.html">ModuleAttribute</a></div>
    <div class="level3"><span class="xref">ModuleDependencyAttribute</span></div>
  </div>
  <div class="inheritedMembers">
    <h5>Inherited Members</h5>
    <div>
      <a class="xref" href="../../api/ParmaGIS.Core.Modularity.ModuleAttribute.html#ParmaGIS_Core_Modularity_ModuleAttribute_Value">ModuleAttribute.Value</a>
    </div>
    <div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="../../api/ParmaGIS.html">ParmaGIS</a><a class="xref" href="../../api/ParmaGIS.Core.html">Core</a><a class="xref" href="../../api/ParmaGIS.Core.Modularity.html">Modularity</a></h6>
  <h6><strong>Assembly</strong>: ParmaGIS.Core.dll</h6>
  <h5 id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">[AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
public class ModuleDependencyAttribute : ModuleAttribute</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  <span class="small pull-right mobile-hide">
    <span class="divider">|</span>
    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/new/origin/dev/apiSpec/new?filename=ParmaGIS_Core_Modularity_ModuleDependencyAttribute__ctor_System_String_.md&amp;value=---%0Auid%3A%20ParmaGIS.Core.Modularity.ModuleDependencyAttribute.%23ctor(System.String)%0Asummary%3A%20'*You%20can%20override%20summary%20for%20the%20API%20here%20using%20*MARKDOWN*%20syntax'%0A---%0A%0A*Please%20type%20below%20more%20information%20about%20this%20API%3A*%0A%0A">Improve this Doc</a>
  </span>
  <span class="small pull-right mobile-hide">
    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/blob/origin/dev/common/src/ParmaGIS.Core/Modularity/ModuleDependencyAttribute.cs/#L8">View Source</a>
  </span>
  <a id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute__ctor_" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute.#ctor*"></a>
  <h4 id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute__ctor_System_String_" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute.#ctor(System.String)">ModuleDependencyAttribute(string)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ModuleDependencyAttribute(string moduleName)</code></pre>
  </div>
  ...
  <span class="small pull-right mobile-hide">
    <span class="divider">|</span>
    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/new/origin/dev/apiSpec/new?filename=ParmaGIS_Core_Modularity_ModuleDependencyAttribute_ModuleName.md&amp;value=---%0Auid%3A%20ParmaGIS.Core.Modularity.ModuleDependencyAttribute.ModuleName%0Asummary%3A%20'*You%20can%20override%20summary%20for%20the%20API%20here%20using%20*MARKDOWN*%20syntax'%0A---%0A%0A*Please%20type%20below%20more%20information%20about%20this%20API%3A*%0A%0A">Improve this Doc</a>
  </span>
  <span class="small pull-right mobile-hide">
    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/blob/origin/dev/common/src/ParmaGIS.Core/Modularity/ModuleDependencyAttribute.cs/#L13">View Source</a>
  </span>
  <a id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute_ModuleName_" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute.ModuleName*"></a>
  <h4 id="ParmaGIS_Core_Modularity_ModuleDependencyAttribute_ModuleName" data-uid="ParmaGIS.Core.Modularity.ModuleDependencyAttribute.ModuleName">ModuleName</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
          ...
          <div class="hidden-sm col-md-2" role="complementary">
            <div class="sideaffix">
              <div class="contribution">
                <ul class="nav">
                  <li>
                    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/new/origin/dev/apiSpec/new?filename=ParmaGIS_Core_Modularity_ModuleDependencyAttribute.md&amp;value=---%0Auid%3A%20ParmaGIS.Core.Modularity.ModuleDependencyAttribute%0Asummary%3A%20'*You%20can%20override%20summary%20for%20the%20API%20here%20using%20*MARKDOWN*%20syntax'%0A---%0A%0A*Please%20type%20below%20more%20information%20about%20this%20API%3A*%0A%0A" class="contribution-link">Improve this Doc</a>
                  </li>
                  <li>
                    <a href="https://github.com/ParmaGIS/ParmaGIS.Net/blob/origin/dev/common/src/ParmaGIS.Core/Modularity/ModuleDependencyAttribute.cs/#L5" class="contribution-link">View Source</a>
                  </li>
                </ul>
              </div>
